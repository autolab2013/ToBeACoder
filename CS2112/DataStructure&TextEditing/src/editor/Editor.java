...
public class Editor extends Application {
    ...
    static final private String webdir =
            "http://www.cs.cornell.edu/courses/cs2112/2014fa/hw/a3/";
    ...
    private void setupDictionary(final HTMLEditor htmlEditor, final Stage stage) {
        ...
        ImageView graphic =
                new ImageView(new Image(webdir + "dict.png", 24, 24, true, true));
        ...
        loadDict.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent arg0) {
                ...
                editorModel.loadDictionary(dict);
    ...
    private void setupSpellCheck(final HTMLEditor htmlEditor) {
        ToolBar bar = getToolBar(htmlEditor);
        ImageView graphic =
                new ImageView(new Image(webdir + "check.png",
                                        24,
                                        24,
                                        true,
                                        true));
        ...
        spellCheck.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent arg0) {
                ...
                timer.setText("Spell check time: "
                        + editorModel.getSpellCheckTime() + " μs.");
            }
        });
    }
    ...
    private void setupClearFormatting(final HTMLEditor htmlEditor) {
        ToolBar bar = getToolBar(htmlEditor);
        ImageView graphic =
                new ImageView(new Image(webdir + "cancel.png",
                                        24,
                                        24,
                                        true,
                                        true));
        ...
        clear.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent arg0) {
                htmlEditor.setHtmlText(editorModel.clearFormatting(htmlEditor.getHtmlText()));
            }
        });
    }
    ...
    private void setupSearch(final HTMLEditor htmlEditor) {
        ...
        ImageView graphic =
                new ImageView(new Image(webdir + "search.png",
                                        24,
                                        24,
                                        true,
                                        true));
        ...
        searchButton.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent arg0) {
                htmlEditor.setHtmlText(editorModel.search(searchBox.getText(),
